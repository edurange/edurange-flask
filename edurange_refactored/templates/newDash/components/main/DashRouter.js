...
function DashRouter() {
  ...
  console.log("jwt_auth is: ",jwt_authenticated_state)
  const navDataToShow = jwt_authenticated_state === true ? DashSideNav_admin_logged_in : DashSideNav_logged_out; // needs update for permissions!  ***************
  return (
        ...
        <div className="newdash-infopane-frame">
          <div className='newdash-infopane-content'>
            <Routes>
              ...
              <Route path="/api/jwt_auth" element={<JWTAUTH  />} />
            </Routes>
          </div>
        </div>
      </div>
