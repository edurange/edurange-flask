...
from ...flask.modules.utils.auth_utils import jwt_and_csrf_required
...
@blueprint_routing_clone.route("/edurange3/api/jwt_auth", methods=["POST"]) # DEV_ONLY
...
@blueprint_routing_clone.route("/edurange3/api/sample", methods=["POST"]) # DEV_ONLY
@jwt_and_csrf_required
def sample_route():
