...
function HomeChapter (  ) {
    ...
    <div>
        ...
        <br></br>
        <br></br>
        To play a scenario, connect with SSH!  SSH connection information and connection buttons are on the bottom of this guide viewport.
